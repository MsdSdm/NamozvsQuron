package bilibqoy.mohirjonnnikibuilova.namozvsquron.Mosques;
...
public class MosquesAct extends FragmentActivity implements LocationListener {
        ...
        if (googleMap == null) {
            ...
            mapFragment.getMapAsync(new OnMapReadyCallback() {
                ...
                public void onMapReady(GoogleMap googleMap) {
                    ...
                    MosquesAct.this.googleMap = googleMap;
                    //ok - proceed
                    googleMap.setMapType(GoogleMap.MAP_TYPE_NORMAL);
                    //create marker array
                    markers = new Marker[MAX_PLACES];
    ...
    void enableGPS() {
        ...
        if (ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
            ...
            locMan.requestLocationUpdates(LocationManager.GPS_PROVIDER, 30000, 50, this);
    ...
    private void updatePlaces(Location lastLoc) {
        ...
        {
            locMan= (LocationManager) MosquesAct.this.getSystemService(LOCATION_SERVICE);
            ...
            else
            {
                ...
                Toast.makeText(MosquesAct.this, "Location could not be found, please enable location and allow app to use location and internet.", Toast.LENGTH_LONG).show();
                MosquesAct.this.finish();
            }
        }
        ...
        if(lastLoc !=null ) {
            ...
            if(isNetworkAvailable()) {
                ...
                Toast.makeText(MosquesAct.this,"No internet access, app will not work properly",Toast.LENGTH_LONG).show();
            }
        }
        else
        {
            ...
            try {
                ...
                for (int p = 0; p < placesArray.length(); p++) {
                    ...
                    try {
                        ...
                        Toast.makeText(MosquesAct.this,"Could not fetch data from server", Toast.LENGTH_LONG).show();
                        missingValue = true;
                        jse.printStackTrace();
                    }
    ...
    protected void onResume() {
        super.onResume();
        if (googleMap != null) {
            locMan.requestLocationUpdates(LocationManager.NETWORK_PROVIDER, 30000, 200, this);
        }
    }
    ...
    public class WifiReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (netInfo != null && netInfo.getType() == ConnectivityManager.TYPE_WIFI)
                ...
                if(googleMap==null && markers==null)
                    Toast.makeText(MosquesAct.this,"Please enable internet, or the app will not work properly.", Toast.LENGTH_LONG).show();
        }
    }
