...
import bilibqoy.mohirjonnnikibuilova.namozvsquron.Activities.ActivityQuranAr;
    ...
    private class DownloadingTask extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void result) {
            try {
                ...
                progressDialog.dismiss();
                Toast.makeText(context,"! Downlooad Failed with Exception - " + e.getLocalizedMessage(), Toast.LENGTH_SHORT).show();
        ...
        protected Void doInBackground(Void... arg0) {
            try {
                ...
                if (new CheckForSDCard().isSDCardPresent()) {
                    ...
                    apkStorage = new File(Environment.getExternalStorageDirectory() + "/" + "NamozvaQur_on"/*+"/"+"Document"*/);
                } else
